...
export const SERVICES: ServiceItem[] = [
    ...
    { id: "suspension",      name: "Suspension",            slug: "suspension",          icon: Settings2,      colSpan: 1, rowSpan: 1, iconColor: "text-blue-400",  desc: "Shocks, coilovers, bushes & steering components.",              img: "/images/suspension.png",        query: "suspension steering repair service",     category: "mechanical"   },
