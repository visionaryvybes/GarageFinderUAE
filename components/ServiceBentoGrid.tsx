    ...
    return (
        <section className="relative z-10 w-full max-w-7xl mx-auto px-4 py-16">
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <a
                    href="/services"
                    className="hidden md:flex items-center gap-2 px-4 py-2 rounded-full border border-zinc-800 hover:bg-zinc-900 hover:border-zinc-700 transition-all text-sm font-bold text-zinc-300"
                >
