...
export default function Hero({ onSearch }: HeroProps) {
  ...
  return (
    <>
      ...
      {/* ── DESKTOP layout (sm+) ── full-screen background overlay */}
      <section className="hidden sm:block relative w-full overflow-hidden bg-[#09090b]" style={{ minHeight: "85vh" }}>
        {/* Background image */}
