              ...
              {activeBrand && (
                <div className="px-5 pt-4 shrink-0">
                  <button
                    ...
                    className="w-full py-2  border border-zinc-800 text-sm text-zinc-400 hover:border-zinc-700 hover:text-white transition-all flex items-center justify-center gap-2"
                  >
                    <X className="w-4 h-4" />
                    Clear brand filter
                  </button>
