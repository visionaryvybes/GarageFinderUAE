    ...
    return (
        <div ref={ref} className="relative">
            <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-[#0a0a0a] border border-[#1a1a1a] hover:border-zinc-700 transition-colors text-sm font-medium text-zinc-300"
            >
            ...
            {open && (
                <div className="absolute top-full mt-1 left-0 w-48 bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl shadow-2xl z-50 py-1 overflow-hidden">
